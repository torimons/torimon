import { MapViewGetters } from '../../src/store/modules/MapViewModule/MapViewGetters';
import { Map, DisplayLevelType } from '../../src/store/types';

export class MockMapViewGetters extends MapViewGetters {
